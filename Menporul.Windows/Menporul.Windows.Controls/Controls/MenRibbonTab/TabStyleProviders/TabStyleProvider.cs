...
namespace System.Windows.Forms
{
    ...
    public abstract class TabStyleProvider : Component
    {
        ...
        protected TabStyleProvider(MenRibbonTab tabControl)
        {
        ...
        protected MenRibbonTab _TabControl;
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Design", "CA1051:DoNotDeclareVisibleInstanceFields")]
        ...
        protected virtual Brush GetTabBackgroundBrush(int index)
        {
            ...
            Color bgColor = Color.FromArgb(242, 242, 242);
            ...
            {
                bgColor = Color.FromArgb(167, 217, 245);
            }
        ...
        private void DrawTabFocusIndicator(GraphicsPath tabpath, int index, Graphics graphics)
        {
            if (this._FocusTrack && this._TabControl.Focused && index == this._TabControl.SelectedIndex)
            {
                ...
                Rectangle focusRect = new Rectangle((int)pathRect.X, (int)pathRect.Y, (int)pathRect.Width, 4);
                Brush focusBrush = new LinearGradientBrush(focusRect, this._FocusColor, SystemColors.Window, LinearGradientMode.Vertical); ;
